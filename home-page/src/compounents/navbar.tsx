    ...
    >
      ...
      <div className='lg:flex flex-row justify-between items-center gap-12 hidden font-outfit text-2xl'>
        ...
        <div className='flex flex-row justify-between items-center gap-8 text-2xl'>
          <button className='text-[#001B66] border-2 border-[#001B66] px-8 py-2 rounded-xl hover:text-[#F9F4F1] hover:bg-[#001B66]'>  <a href="https://healthbank.vercel.app/sign-in">Sign in</a></button>
          <button className='text-[#F9F4F1] bg-[#001B66] px-8 py-2 rounded-xl hover:text-[#001B66] hover:bg-[#F9F4F1] hover:border-2 hover:border-[#001B66]'>  <a href="https://healthbank.vercel.app/sign-up">Sign Up</a></button>
        </div>
      </div>
