...
const Features = () => {
  ...
  return (
    <section>
     <h3 className='font-bold text-4xl sm:text-3xl md:text-4xl lg:text-5xl px-4 sm:px-8 md:px-16 lg:px-[100px] py-4 sm:py-6 lg:py-[60px] text-center leading-snug text-custom-blue'>
